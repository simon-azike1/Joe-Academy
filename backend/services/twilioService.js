...
exports.sendBookingNotification = async (booking) => {
  ...
  try {
    const instructorWhatsApp = booking?.instructorWhatsApp || booking?.instructor?.whatsapp || process.env.LECTURER_WHATSAPP_FALLBACK;
